' Based on Michael Comb's original class found at: http://www.codeproject.com/vb/net/math_expression_evaluator.asp
' Extended by Jason Byrne of EVware 4/2007
...
Public Class mcCalc
    ...
    Private m_funcs() As String = {"if", "not", "and", "or", "sin", "cos", "tan", "arcsin", "arccos", _
    ...
    Public Function Eval(ByVal expression As String) As Double
        ' Alias function because I like it capitalized better!
        Return Me.evaluate(expression)
    End Function


    Public Function IsValid(ByVal expression As String) As Boolean
        Dim Evaluator As New mcCalc
        Try
    ...
    Private Function evaluate(ByVal expression As String) As Double

        ' Replace all variables with the values
        For Each v As Variable In Me.Variables.Values
            expression = expression.Replace(v.Name, v.Value)
        Next
    ...
    Private Function calc_function(ByVal func As String, ByVal args As Collection) As Double
        ...
        Select Case func.ToLower
            ...
            Case "if"
                ...
                If Me.evaluate(CStr(args(1))) > 0 Then
                    Return CDbl(args(2))
                Else
                    Return CDbl(args(3))
                End If
            ...
            Case "and"
                ...
                If Me.evaluate(CStr(args(1))) > 0 And Me.evaluate(CStr(args(2))) > 0 Then
                    Return 1
                Else
                    Return 0
                End If
            ...
            Case "or"
                ...
                If Me.evaluate(CStr(args(1))) > 0 Or Me.evaluate(CStr(args(2))) > 0 Then
                    Return 1
                Else
                    Return 0
                End If
    ...
    Private Function is_function(ByVal token As String) As Boolean
        ...
        Try
            Dim lr As Integer = System.Array.BinarySearch(m_funcs, token.ToLower)
