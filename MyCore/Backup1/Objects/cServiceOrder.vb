...
Public Class cServiceOrder
    ...
    Public Sub Open(ByVal Id As Integer)
        ...
        If Me.Database.LastQuery.RowsReturned = 1 Then
            Try
                Me._Id = Id
                Me.BillToNo = SO.Item("customer_no")
                Me.ShipToNo = SO.Item("location_id")
                ...
                Me.Truck = SO.Item("truck_type_id")
                Me.RateType = SO.Item("rate_type_id")
                Me.RateTable = SO.Item("rate_table_id")
                ...
                Me.DateLastUpdated = SO.Item("date_last_updated")
            Catch ex As Exception
