...
Namespace GravityDocument
    ...
    Public Class gDocument
        ...
        Public Function SaveToTemp(ByVal Format As String, Optional ByVal ThenOpen As Boolean = False) As String
            ...
            'Dim FilePath As String = My.Computer.FileSystem.SpecialDirectories.Temp & "\gravity." & Now.Ticks & ".html"
            If Format = "pdf" Then
                Me.SaveToPdf(FilePath)
                'Me.PrintDocumentToPDF()

                'Dim FilePath1 As String = Me.SaveToTemp("html")
                'Dim Print As New MyCore.frmPrint(FilePath1)
                'Print.ShowDialog()
